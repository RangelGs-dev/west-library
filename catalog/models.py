...
class Genre(models.Model):
    # Modelo que representa po genero de livro.
    name = models.CharField(max_length=200, help_text='Insira um gênero de livro')
...
class Book(models.Model):
    # modelo para representar o livro
...
class BookInstance(models.Model):
    # modelo que representa uma cópia um livro
    ...
    status = models.CharField(
        ...
        blank=True,
        default='m',
        help_text='Disponibilidade de reserva',
    )

    class Meta:
        ordering = ['due_back']
        permissions = (('can_mark_returned', 'Seta devolução do livro'),)
